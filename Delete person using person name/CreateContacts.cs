...
namespace Delete_person_using_person_name
{
    public class CreateContacts
    {
        ...
        public static void DeletePerson()
        {
            ...
            Console.WriteLine("Enter the name of the person you want to deleted");
            ...
            {
                Console.WriteLine("That name is not match. Press any key to continue.");
                Console.ReadKey();
                return;
            }
        ...
        public static void DeletePersonFromList(PersonalDetails contact)
        {
            ...
            if (Console.ReadKey().Key == ConsoleKey.Y)
            {
                ...
                Console.Clear();
                Console.WriteLine("Person is deleted. Press any key to continue.");
                Console.ReadKey();
            }
        }
        ...
        {
            Console.Clear();
            Console.WriteLine("Enter the first name of the person you want to delete it.");
